...
<nav class="nav justify-content-end">
    <a href="../php/login.php" class="nav-item ">Se Connecter</a>
        ...
        <form method="post" action="../php/inscription.php">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <label>Si vous souhaitez faire des gardes en langues étrangères, merci de préciser combien ici
                        :</label>
                    <select class="form-control" id="select-langue" onchange="langue()">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="exampleCheck1">J'accepte les conditions générales
                        d'utilisation</label>
                </div>
                <br>
